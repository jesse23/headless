import { ActionDefinition, ViewModelDefinition } from '@headless/types';
import { transformDeclComponent } from '@headless/transform';
...
export const transpileDeclComponent = async (
  jsonPath: string,
  ...
  let content = transformDeclComponent(vmDef, parseView(htmlContent)).join(
    '\n'
  );
